...
|------------------------|----------------|-------------------------------------------------------------------------------------------------------------------|
| [KeepinCRM Reverse API](./keepincrm.m) | Отримання та створення задач з використанням публічного API | n8n, JS, DevTools |
| [Slack бот для автоматизації](https://github.com/LyubomirDev/custom-integrations-cases/pull/1) | Відправлення повідомлень, робота з thread'ами, кастомні відповіді | Slack API, Slack App, n8n |
